...
and give it an API key + base URL:
...
| `ApiKey` | `""` | Sent as `X-Api-Key` (required for sender) |
| `BaseUrl` | `""` | Collector base URL (required for sender) |
...
{
  "LogCollector": {
    "Sender":     { "EnableSenderSink": true, "ApiKey": "your-api-key", "BaseUrl": "https://collector.example.com" },
